    ...
    render() {
        return (
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                <FollowingHeader navigation={this.props.navigation} selectedTab="FollowingTeams" />
                <ScrollView
                    style={{
                        width: wp('100%'),
                            ...
                            return item.like ? (
                                <View
                                    ...
                                    <View
                                        ...
                                        <Text style={{fontSize: hp('1.25%'), color: '#444'}}>
