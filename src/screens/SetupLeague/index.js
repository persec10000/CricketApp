                ...
                <ScrollView style={{paddingHorizontal: wp('2.0%'), height: hp('60%')}}>
                    <View style={{marginVertical: hp('2.0%'), alignItems: 'center'}}>
                        <View
                            ...
                            <Text style={{width: wp('90%'), color: '#666', fontSize: hp('1.75%')}}>
                                LEAGUE SET UP
                            </Text>
                            <TextInput
                                style={{
                            ...
                            <TouchableOpacity
                                ...
                                <TextInput
                                    value={this.state.planedStartDate}
                                    editable={false}
                                    style={{
                                        backgroundColor: '#fff',
                                        paddingVertical: hp('0.5%'),
                            ...
                            <TextInput
                                value={this.state.sponsor.facebook}
                                style={{
                                    paddingVertical: hp('0.5%'),
                                    borderWidth: 1,
                                    borderRadius: 5,
                            ...
                            />
                            <TextInput
                                value={this.state.sponsor.twitter}
                                style={{
                                    paddingVertical: hp('0.5%'),
                                    borderWidth: 1,
                                    borderRadius: 5,
                                    ...
                                    <ScrollView
                                        ...
                                        {sponsorList.map((item, key) => {
                                            return (
                                                <TouchableOpacity
                                                    key={key}
                                                    onPress={() => this.selectSponsor(item)}>
                                                    <Text
                                                        style={[
                                                            {
                                                                width: wp('80%'),
