...
class SetupSettingsScreen extends React.Component {
    ...
    setConfirmSettingsPhase(value) {
        if (this.state.confirmSettingsPhase == 'first') {
            if (this.state.overPerInnings == null || this.state.maxOverPerBowler == null) return;
        } else {
            if (this.state.syncFrequency == null || this.state.scoreFormat == null) return;
        }
        this.setState({confirmSettingsPhase: value});
    }

    setConfirmBalls = () => {
        if (this.state.confirmBalls == false) this.setState({confirmBalls: true});
        else this.setState({confirmBalls: false});
    };

    setRebowlNoBallsAndWideBalls = () => {
        if (this.state.rebowlNoBallsAndWideBalls == false)
            this.setState({rebowlNoBallsAndWideBalls: true});
        else this.setState({rebowlNoBallsAndWideBalls: false});
    };

    setApplyToAllMatches = () => {
        if (this.state.applyToAllMatches == false) this.setState({applyToAllMatches: true});
        else this.setState({applyToAllMatches: false});
    };
        ...
        return (
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                <SetupHeader
                    ...
                    leagueStack={false}
                />
                <ScrollView style={{paddingHorizontal: wp('2.0%'), height: hp('60%')}}>
                    <View style={{marginVertical: hp('2.0%'), alignItems: 'center'}}>
                        <View
                            ...
                            <TouchableOpacity
                                ...
                                <TextInput
                                    value={this.state.overPerInnings}
                                    editable={false}
                                    style={{
                                        backgroundColor: '#fff',
                                        paddingVertical: hp('0.5%'),
                            ...
                            <TouchableOpacity
                                ...
                                <TextInput
                                    value={this.state.maxOverPerBowler}
                                    editable={false}
                                    style={{
                                        backgroundColor: '#fff',
                                        paddingVertical: hp('0.5%'),
                                ...
                                <TouchableOpacity
                                    onPress={() => {
                                        if (this.state.ballPerOver > 0)
                                            this.setState({
                                                ballPerOver: this.state.ballPerOver - 1,
                                            });
                                    }}>
                                    <Icon
                                        name="minuscircleo"
                                ...
                                <TouchableOpacity
                                    onPress={() => {
                                        if (this.state.noBallValue > 0)
                                            this.setState({
                                                noBallValue: this.state.noBallValue - 1,
                                            });
                                    }}>
                                    <Icon
                                        name="minuscircleo"
                            ...
                            <View
                                ...
                                <CheckBox
                                    fontSize={hp('1.5%')}
                                    width={wp('30%')}
                                    checked={this.state.confirmBalls}
                                    iconColor="#13c0fa"
                                    text="CONFIRM BALLS"
                                    onPress={() => this.setConfirmBalls()}
                                />
                                <CheckBox
                                    fontSize={hp('1.5%')}
                                    width={wp('60%')}
                                    checked={this.state.rebowlNoBallsAndWideBalls}
                                    iconColor="#13c0fa"
                                    text="RE-BOWL NO BALLS AND WIDE BALLS"
                                    onPress={() => this.setRebowlNoBallsAndWideBalls()}
                                />
                            </View>
                            {this.state.confirmSettingsPhase == 'first' ? (
                                <TouchableOpacity
                                    style={{alignSelf: 'flex-start', marginVertical: hp('1.0%')}}
                                    onPress={() => {
                            ...
                            <View style={{width: wp('90%')}}>
                                <CheckBox
                                    fontSize={hp('1.5%')}
                                    width={wp('60%')}
                                    checked={this.state.applyToAllMatches}
                                    iconColor="#13c0fa"
                                    text="Apply to all matches"
                                    onPress={() => this.setApplyToAllMatches()}
                                />
                            </View>
                            <Text
                                style={{
                                ...
                                A group = each team plays every other team in their group. Or select
                                custom matched per team
                            </Text>
