...
let teamData = [
    ...
    },
    {
        key: 4,
        teamName: 'RR',
        teamImage: require('../../assets/images/RR.png'),
        status: 'Accepted',
        iconName: 'check-circle',
        iconColor: '#a0a0a0',
        iconGroup: 'material-community',
...
class SetupTeamsScreen extends React.Component {
    ...
    selectTeam(team) {
        ...
        teamData.map((item, key) => {
            if (item.teamName == team.name) exist = true;
        });
        if (exist) return;
        teamData.push({
                    ...
                    <View style={{marginVertical: hp('2.0%'), alignItems: 'center'}}>
                        <View
                            ...
                            <Text
                                ...
                                SCHEDULE THE TOURNAMENT/LEAGUE
                            </Text>
                            <Text
                                style={{
                                    marginTop: hp('0.0%'),
                                    ...
                                    <ScrollView
                                        ...
                                        {leagueList.map((item, key) => {
                                            return (
                                                <TouchableOpacity
                                                    key={key}
                                                    onPress={() => this.selectLeague(item.name)}
                                                    style={[
                                                        {
                                                            flexDirection: 'row',
                                                            justifyContent: 'center',
                                        ...
                                        {scheduleTypeList.map((item, key) => {
                                            return (
                                                <TouchableOpacity
                                                    key={key}
                                                    onPress={() =>
                                                        this.selectScheduleType(item.name)
                                                    }>
                                                    <Text
                                                        style={[
                                                            {
                                        ...
                                        {roundOfPlayList.map((item, key) => {
                                            return (
                                                <TouchableOpacity
                                                    key={key}
                                                    onPress={() =>
                                                        this.selectRoundOfPlay(item.name)
                                                    }>
                                                    <Text
                                                        style={[
                                                            {
