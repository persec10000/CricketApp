...
const leagueList = [
    {
        key: '1',
        name: 'India Premier League 2018-2019',
    ...
    {
        key: '2',
        name: 'India Second League 2018-2019',
        image: images.searchPlayersPlayerJpg,
        type: 'crystal-ball',
        startDate: 'September 1 2018',
        endDate: 'March 31 2019',
    ...
    {
        key: '3',
        name: 'India Champion League 2018-2019',
        image: images.searchPlayersPlayerJpg,
        type: 'crystal-ball',
        startDate: 'September 1 2018',
        endDate: 'March 31 2019',
    ...
    {
        key: '5',
        name: 'Barbaca Cup 2019',
        image: images.searchPlayersPlayerJpg,
        type: 'crystal-ball',
        startDate: 'April 1 2019',
        endDate: 'September 30 2019',
        like: true,
        teamImage: require('../../assets/images/DD.png'),
    },
    {
        key: '6',
        name: 'Romio Cup 2019',
    ...
    {
        key: '7',
        name: 'Sanemala Cup 2019',
        image: images.searchPlayersPlayerJpg,
        type: 'crystal-ball',
        startDate: 'April 1 2019',
        endDate: 'September 30 2019',
        like: true,
        teamImage: require('../../assets/images/RCB.png'),
    },
];
                ...
                <ScrollView
                    ...
                    <View style={{paddingVertical: hp('2.0%'), paddingHorizontal: wp('1.0%')}}>
                        <View
                            ...
                            <Text style={{fontSize: hp('2.0%'), fontWeight: 'bold', color: '#444'}}>
                            ...
                            return item.like ? (
                                <View
                                    ...
                                    <TouchableOpacity
                                        ...
                                        onPress={() => this.deletePlayer(item)}>
                                        <Icon
                                            name="delete-circle"
                                            type="material-community"
                                            color="#fc8d6f"
