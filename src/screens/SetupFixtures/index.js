...
const matchResultData = [
    {
        key: '1',
        matchStadium: 'FEROZ SHAH KOTLA GROUND',
        matchDate: 'MONDAY 28 APRIL 2019',
        matchTime: '15:00',
        matchResult: 'First stage - Group B, Eden Garden, Kolkata',
        awayTeamScore1: '178/6',
        awayTeamScore2: '20/20',
        homeTeamScore1: '181/2',
        homeTeamScore2: '18.3/20',
        homeTeam: 'CSK',
    ...
    {
        key: '3',
        matchStadium: 'PUNE STADIUM',
        matchDate: 'MONDAY 27 APRIL 2019',
        matchTime: '15:00',
        matchResult: 'First stage - M. A. Chidambaram Stadium',
        awayTeamScore1: '178/6',
        awayTeamScore2: '20/20',
        homeTeamScore1: '181/2',
        homeTeamScore2: '18.3/20',
    ...
    },
    {
        ...
        matchTime: '09:00',
        matchResult: 'First stage - Wankhede Stadium',
        awayTeamScore1: '178/6',
        awayTeamScore2: '20/20',
        homeTeamScore1: '181/2',
        homeTeamScore2: '18.3/20',
...
const borderBottomColors = ['#cc3637', '#ea9d1b', '#4d88c0', '#673e8a', '#cc3637'];
                                ...
                                <View key={key}>
                                    ...
                                    <View
                                        style={{
                                            ...
                                            width: wp('94%'),
                                            backgroundColor: '#fff',
                                            borderBottomColor: borderBottomColors[key],
                                        }}>
                                        <View
                                            style={{
                                                flexDirection: 'row',
                                            ...
                                            <View style={{width: wp('8.0%')}} />
                                            <TouchableOpacity
                                                style={{width: wp('16%'), alignItems: 'center'}}
                                                onPress={() =>
                                            ...
                                            <View
                                                style={{width: wp('12%'), alignItems: 'flex-end'}}>
                                                <Text
                                                    style={{
                                                        textAlign: 'right',
                                                        fontWeight: 'bold',
