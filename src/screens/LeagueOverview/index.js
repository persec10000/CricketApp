...
const standingData = [
    {
        ...
        nrr: '+0.284',
        pts: '18',
        teamImage: require('../../assets/images/CSK.png'),
        form: ['#3aa757', '#ea4335', '#3aa757', '#3aa757', '#3aa757'],
    },
    {
        key: '2',
        num: '2',
        ...
        nrr: '+0.284',
        pts: '18',
        teamImage: require('../../assets/images/KKR.png'),
        form: ['#ea4335', '#3aa757', '#3aa757', '#3aa757', '#3aa757'],
    },
    {
        key: '3',
        num: '3',
        ...
        nrr: '+0.284',
        pts: '18',
        teamImage: require('../../assets/images/SRH.png'),
        form: ['#ea4335', '#3aa757', '#ea4335', '#ea4335', '#3aa757'],
    },
    {
        key: '4',
        num: '4',
        ...
        pts: '18',
        teamImage: require('../../assets/images/CSK.png'),
        form: ['#3aa757', '#ea4335', '#3aa757', '#3aa757', '#ea4335'],
    },
    {
        key: '5',
        num: '5',
        backgroudColor: '#dad9d5',
        color: '#666',
        ...
        nrr: '+0.284',
        pts: '18',
        teamImage: require('../../assets/images/KXIP.png'),
        form: ['#ea4335', '#3aa757', '#ea4335', '#3aa757', '#ea4335'],
    },
    {
        key: '6',
        num: '6',
        ...
        pts: '18',
        teamImage: require('../../assets/images/CSK.png'),
        form: ['#3aa757', '#ea4335', '#3aa757', '#ea4335', '#ea4335'],
    },
    {
        key: '7',
        num: '7',
        ...
        nrr: '+0.284',
        pts: '18',
        teamImage: require('../../assets/images/MI.png'),
        form: ['#ea4335', '#ea4335', '#3aa757', '#ea4335', '#ea4335'],
    },
    {
        key: '8',
        num: '8',
        ...
        pts: '18',
        teamImage: require('../../assets/images/SRH.png'),
        form: ['#3aa757', '#ea4335', '#ea4335', '#ea4335', '#ea4335'],
    },
];
                ...
                <ScrollView style={{paddingHorizontal: wp('2.0%'), height: hp('60%')}}>
                    <View style={{paddingTop: hp('0.0%'), paddingBottom: hp('2.0%')}}>
                        <Text
                            ...
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut dapibus leo
                            id neque pellentesque, at viverra nisl condimentum. Nullam pharetra
                            turpis in dignissim dignissim. Pellentesque habitant morbi tristique
                            senectus et netus et malesuada fames ac turpis egestas. Sed eu vehicula
                            tellus. In suscipit nunc non risus convallis, ut consequat libero
                            faucibus.
                        </Text>
                        <View
                            style={{
                                ...
                                return (
                                    <View
                                        ...
                                        <TouchableOpacity
                                            ...
                                            <View
                                                style={{width: wp('6.0%'), alignItems: 'center'}}
                                                onPress={() =>
                                                    this.props.navigation.navigate(
                                                        'TeamProfileOverview',
                                                    )
                                        ...
                                        <View
                                            ...
                                            <Icon
                                                ...
                                                color={item.form[0]}
                                                size={wp('1.5%')}
                                                iconStyle={{paddingHorizontal: wp('0.25%')}}
                                            />
                                            <Icon
                                                name="circle"
                                                type="font-awesome"
