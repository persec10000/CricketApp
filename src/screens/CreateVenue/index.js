        ...
        return (
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                <LinearGradient
                    ...
                    <TopMenu navigation={this.props.navigation} title="ADD/EDIT VENUE" />
                </LinearGradient>
                    ...
                    <View
                        ...
                        {this.state.status ? (
                            <View
                                ...
                                />
                                <TouchableOpacity
                                    style={{marginLeft: wp('10.0%')}}
                                    onPress={() => this.changeStatus(false)}>
                                    <Icon
                        ...
                        {this.state.status ? (
                            <Text
                                ...
                                Contact the following contact person by phone or email 48 hrs ahead
                                of booking.
                            </Text>
                        ) : (
                            <TextInput
                        ...
                        {!this.state.status ? (
                            <TouchableOpacity
                                style={{marginVertical: hp('2.0%')}}
                                onPress={() => this.changeStatus(true)}>
                                <Text
                                    style={{
                                        borderRadius: 5,
                                ...
                                <ScrollView
                                    ...
                                    {venueTypeList.map((item, key) => {
                                        return (
                                            <TouchableOpacity
                                                key={key}
                                                onPress={() => this.selectVenueType(item.name)}
                                                style={[
                                                    {
                                                        flexDirection: 'row',
                                                        justifyContent: 'center',
                                ...
                                <ScrollView
                                    ...
                                    {costTypeList.map((item, key) => {
                                        return (
                                            <TouchableOpacity
                                                key={key}
                                                onPress={() => this.selectCostType(item.name)}
                                                style={[
                                                    {
                                                        flexDirection: 'row',
                                                        justifyContent: 'center',
