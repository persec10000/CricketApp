    ...
    render() {
        return (
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                <SearchHeader navigation={this.props.navigation} selectedTab="SearchTeam" />
                <ScrollView
                    style={{
                        width: wp('100%'),
                                ...
                                <TouchableOpacity
                                    ...
                                    <View
                                        style={{
                                            ...
                                            alignItems: 'center',
                                            backgroundColor: '#413178',
                                        }}>
                                        <Image
                                            source={require('../../assets/images/KKR.png')}
                                            style={{
                                                width: wp('20%'),
                                                height: wp('16%'),
                                                resizeMode: 'contain',
                                    ...
                                    <View
                                        ...
                                        <Text style={{fontSize: hp('1.25%'), color: '#666'}}>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            Ut dapibus leo id neque pellentesque, at viverra nisl
                                            condimentum.
                                        </Text>
                                        <Text style={{fontSize: hp('1.25%'), color: '#666'}}>
