...
const notificationList = [
    {
        ...
        borderRadius: 100,
        imageType: 'cover',
        title: 'Join Request from John Done',
        pastTime: '15 mins ago.',
        type: 'joinTeam',
        status: 'waiting',
        collapsed: false,
        image: images.commentsPersonJpg,
    },
    {
        key: '2',
        borderColor: '#8f1552',
        borderRadius: 0,
        imageType: 'contain',
        title: 'Would like to Sponsor of Knight Riders Team?',
        pastTime: '30 mins ago.',
        type: 'sponsorRequest',
        status: 'maybeLater',
        collapsed: false,
        image: images.sponsor1Png,
    },
    {
        key: '3',
        borderColor: '#3f3689',
        borderRadius: 0,
        imageType: 'contain',
        title: 'League Invitatoin from Knight Night Riders pvt ltd',
        pastTime: '1 hour ago.',
        type: 'joinLeague',
        status: 'approved',
        collapsed: false,
    ...
    },
    {
        ...
        borderRadius: 100,
        imageType: 'cover',
        title: 'Join request from Gabrial Acostar',
    ...
    },
    {
        ...
        borderRadius: 100,
        imageType: 'cover',
        title: 'Join request from Tom Debolski',
    ...
    },
    {
        ...
        borderRadius: 100,
        imageType: 'cover',
        title: 'Join request from Gary Cornell',
        pastTime: '20 hours ago.',
        type: 'joinTeam',
        status: 'rejected',
        collapsed: false,
        image: images.commentsPersonJpg,
    },
    {
        ...
        borderRadius: 100,
        imageType: 'cover',
        title: 'Join request from Kathey Ruiz',
        pastTime: '2 days ago.',
        type: 'joinTeam',
        status: 'approved',
        collapsed: false,
        ...
        return (
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                <LinearGradient
                    ...
                    <TopMenu navigation={this.props.navigation} title="NOTIFICATIONS" />
                </LinearGradient>
                <ScrollView
                    style={{
                        width: wp('100%'),
                            ...
                            return (
                                <View
                                    ...
                                    <View
                                        ...
                                        <TouchableOpacity
                                            onPress={() =>
                                                this.changeCollapsed(key, !item.collapsed)
                                            }>
                                            {item.collapsed ? (
                                                <Text
                                                    style={{fontSize: hp('1.25%'), color: '#444'}}>
                                                    Hi, I am very interested to join your team.
                                                    Lorem ipsum dolor sit amet, consectetur
                                                    adipiscing elit. Ut dapibus leo id neque
                                                    pellentesque, at viverra nisl condimentum.
                                                </Text>
                                            ) : (
                                                <Text
                                                    numberOfLines={1}
