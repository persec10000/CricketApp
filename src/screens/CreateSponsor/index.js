...
class CreateSponsorScreen extends React.Component {
    ...
    changeStatus() {
        if (this.state.status == true) this.setState({status: false});
                                        ...
                                        {states.map((item, key) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    {/* <View style={{width: wp('12.0%'), justifyContent: 'center', alignItems: 'center'}}>
