...
const teamList = [
    {
        ...
        owner: 'Knight Rider Sports Pvt Ltd.',
        coach: 'Ramesh Jadav',
        homeground: 'Eden Garden, Kolkata',
        manager: 'Manish Gupta',
        email: 'Manish.gupta@cricketpro.com',
    ...
    },
    {
        ...
        owner: 'Knight Rider Sports Pvt Ltd.',
        coach: 'Ramesh Jadav',
        homeground: 'Sweeden Garden, Sweeden',
        manager: 'Joseph Samgi',
        email: 'Joseph.samgi@cricketpro.com',
    ...
    },
    {
        ...
        owner: 'Knight Rider Sports Pvt Ltd.',
        coach: 'Ramesh Jadav',
        homeground: 'Polish Garden, Polish',
        manager: 'Geudoti Mana',
        email: 'Geudoti.mana@cricketpro.com',
    ...
    },
    {
        ...
        owner: 'Knight Rider Sports Pvt Ltd.',
        coach: 'Ramesh Jadav',
        homeground: 'Marconi Garden, Marconi',
        manager: 'Baidue Seldiman',
        email: 'Baidue.seldiman@cricketpro.com',
    ...
    },
    {
        ...
        owner: 'Knight Rider Sports Pvt Ltd.',
        coach: 'Ramesh Jadav',
        homeground: 'Pounchar Garden, Pounchar',
        manager: 'Kerena Simon',
        email: 'Kerena.simon@cricketpro.com',
        phone: '+91 444-444-4444',
    },
];
...
class JoinRequestScreen extends React.Component {
    ...
    setSelectTeamModalVisible(visible) {
        ...
        if (visible == true) StatusBar.setBackgroundColor('#626262', true);
        else StatusBar.setBackgroundColor('#f4f4f4', true);
    }
    ...
    setIncludeLinkToMyProfile = () => {
        ...
        else this.setState({includeLinkToMyProfile: false});
    };
        ...
        return (
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                <LinearGradient
                    ...
                    <TopMenu navigation={this.props.navigation} title="JOIN REQUEST" />
                </LinearGradient>
                <ScrollView
                    style={{width: wp('100%'), paddingHorizontal: wp('2.0%'), height: hp('80%')}}>
                    <View style={{marginVertical: hp('2.0%'), alignItems: 'center'}}>
                        <View
                            ...
                            <View
                                ...
                                <Text style={{color: '#666', fontSize: hp('1.5%')}}>
                                    Select a Club
                                </Text>
                                <TouchableOpacity
                                    style={{
                                    ...
                                    <TextInput
                                        value={
                                            this.state.seletedTeam == null
                                                ? ''
                                                : this.state.seletedTeam.name
                                        }
                                        editable={false}
                                        style={{
                                            backgroundColor: '#fff',
                                    ...
                                    <Icon
                                        ...
                                        color="#888"
                                        size={hp('1.5%')}
                                        containerStyle={{paddingRight: wp('2.0%')}}
                                    />
                                </TouchableOpacity>
                            </View>
                            <View
                                ...
                                <Text
                                    ...
                                    {this.state.seletedTeam == null
                                        ? ''
                                        : this.state.selectedTeam.owner}
                                </Text>
                                <Text style={{color: '#444', fontSize: hp('1.5%')}}>
                                    {'Coach : '}{' '}
                                    {this.state.seletedTeam == null
                                        ? ''
                                        : this.state.selectedTeam.coach}
                                </Text>
                                <Text style={{color: '#444', fontSize: hp('1.5%')}}>
                                    {'Captain : '}{' '}
                                    {this.state.seletedTeam == null
                                        ? ''
                                        : this.state.selectedTeam.captain}
                                </Text>
                                <Text style={{color: '#444', fontSize: hp('1.5%')}}>
                                    {'Home Ground : '}{' '}
                                    {this.state.seletedTeam == null
                                        ? ''
                                        : this.state.selectedTeam.homeground}
                                </Text>
                                <Text
                                    style={{
                                        marginTop: hp('0.5%'),
                                    ...
                                    {this.state.seletedTeam == null
                                        ? ''
                                        : this.state.selectedTeam.manager}
                                </Text>
                                <Text style={{color: '#444', fontSize: hp('1.5%')}}>
                                    {'Email : '}{' '}
                                    {this.state.seletedTeam == null
                            ...
                            <View style={{marginVertical: hp('0.5%'), alignSelf: 'flex-start'}}>
                                <CheckBox
                                    fontSize={hp('1.5%')}
                                    width={wp('60%')}
                                    checked={this.state.includeLinkToMyProfile}
                                    iconColor="#22d498"
                                    text="Include Link to My Profile"
                                    onPress={() => this.setIncludeLinkToMyProfile()}
                                />
                            </View>
                            ...
                            <Modal
                                ...
                                <View style={{justifyContent: 'center', alignItems: 'center'}}>
                                    ...
                                    <ScrollView
                                        ...
                                        style={{position: 'absolute', height: hp('40%')}}>
