...
const teamData = [
    {
        key: '1',
        player1: 'Sunrisers Hyderabad',
        player2: 'b Deepak Chahar',
        runs: '0',
        balls: '1',
        sr: '0.00',
        sec4: '0',
    ...
    {
        key: '2',
        player1: 'Kolkata Knight Riders',
        player2: 'c & b Lungi Ngidi',
        runs: '12',
        balls: '11',
        sr: '133.33',
        sec4: '0',
    ...
    {
        key: '8',
        player1: 'Royal Challengers Bangalore',
        player2: 'run out(MS Dhoni)',
        runs: '13',
        balls: '1',
        sr: '60.33',
        sec4: '0',
            ...
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                ...
                <ScrollView style={{height: hp('45%')}}>
                    <View
                        ...
                        <TeamSelector
                            leftTeamName="SRH"
                            selectedBackgroundColor="#3dc9ec"
                            leftTeamImage={require('../../assets/images/SRH.png')}
                            rightTeamName="CSK"
                        ...
                        <View
                            ...
                            <View
                                ...
                                <Text
                                    ...
                                    Rashid Khan, Siddarth Kaul, Sandeep Sharma, Sandeep Sharma,
                                    Sandeep Sharma
                                </Text>
                            </View>
                            <View
                        ...
                        <View
                            ...
                            <View
                                ...
                                <Text
                                    ...
                                    1-0 (Dhawan, 0.1 ov) , 2-34 (Goswami, 3.5 ov) , 3-36
                                    (Williamson, 4.2 ov) , 4-50 (Al Hasan, 6.4 ov) , 5-69 (Pandey,
                                    11.3 ov), 6-88 (Pathan, 14.6 ov) , 7-139 (Kumar, 19.6 ov)
                                </Text>
                            </View>
                        </View>
                        <BallByBall />
