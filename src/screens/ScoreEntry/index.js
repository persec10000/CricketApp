            ...
            <View style={{backgroundColor: '#f6f8fa'}}>
                <LinearGradient
                    ...
                    <View
                        ...
                        <Image
                            source={require('../../assets/images/CSK.png')}
                            style={{
                                alignSelf: 'center',
                                width: hp('7.0%'),
                                height: hp('6.0%'),
                        ...
                        <Image
                            source={require('../../assets/images/SRH.png')}
                            style={{
                                alignSelf: 'center',
                                width: hp('7.0%'),
                                height: hp('6.0%'),
