    ...
    render() {
        return (
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                <SearchHeader navigation={this.props.navigation} selectedTab="SearchPlayers" />
                <ScrollView
                    style={{
                        width: wp('100%'),
                        ...
                        {playerList.map((item, key) => {
                            return (
                                <TouchableOpacity
                                    ...
                                    onPress={() => this.props.navigation.navigate('PlayerProfile')}>
                                    <Image
                                        source={require('../../assets/images/search-players-player.jpg')}
                                        style={{
                                            width: wp('24%'),
                                            height: wp('18%'),
                                            resizeMode: 'cover',
