    ...
    return (
        <LinearGradient
            ...
            <View style={{alignItems: 'center'}}>
                ...
                <Text style={{color: '#ddd', fontSize: hp('1.25%')}}>
                    Final, 19:00 IST(13:30 GMT), Wankhede Stadium, Mumbai
                </Text>
                <Text style={{color: 'white', fontSize: hp('1.0%')}}>
                ...
                <View
                    ...
                    <View
                        ...
                        <Text style={{alignSelf: 'center', color: 'white', fontSize: hp('1.0%')}}>
                            RUN RATE: 6.95
                        </Text>
                        <Text style={{alignSelf: 'center', color: 'white', fontSize: hp('1.0%')}}>
                            OVERS: 20/20
                    ...
                    <View
                        ...
                        <Image
                            source={images.matchCenterHeaderWingPng}
                            style={{
                                marginTop: hp('1.0%'),
                                width: hp('46%'),
                                height: hp('3.75%'),
