...
class BottomTabsMenu extends React.Component {
    ...
    setSelectMoreBottomTabsModalVisible(visible) {
        ...
        if (visible == true) StatusBar.setBackgroundColor('#c2c2c2', true);
        ...
        return (
            <View style={{borderTopWidth: 1, borderTopColor: '#f6f8fa'}}>
                <LinearGradient
                    ...
                    {tabs.map((item, key) => {
                        return this.props.selectedTab == item.route ? (
                            ...
                            <TouchableOpacity
                                key={key}
                                style={{width: wp('18%'), alignItems: 'center'}}
                                onPress={() => {
